...
![Version](https://img.shields.io/badge/version-4.0.10-blue?style=for-the-badge)
...
[Windows](https://github.com/akosbalasko/yarle/releases/download/v4.0.10/yarle-evernote-to-md-4.0.10.Setup.exe)

[Linux](https://github.com/akosbalasko/yarle/releases/download/v4.0.10/yarle-evernote-to-md-4.0.10-1.x86_64.rpm)

[Debian](https://github.com/akosbalasko/yarle/releases/download/v4.0.10/yarle-evernote-to-md_4.0.10_amd64.deb)

[Mac](https://github.com/akosbalasko/yarle/releases/download/v4.0.10/yarle-evernote-to-md-darwin-x64-4.0.10.zip)
