...
![Version](https://img.shields.io/badge/version-4.8.6-blue?style=for-the-badge)
...
[Windows](https://github.com/akosbalasko/yarle/releases/download/v4.8.6/yarle-evernote-to-md-4.8.6.Setup.exe)

[Linux (.rpm)](https://github.com/akosbalasko/yarle/releases/download/v4.8.6/yarle-evernote-to-md-4.8.6-1.x86_64.rpm)

[Debian (.deb)](https://github.com/akosbalasko/yarle/releases/download/v4.8.6/yarle-evernote-to-md_4.8.6_amd64.deb)

[Mac](https://github.com/akosbalasko/yarle/releases/download/v4.8.6/yarle-evernote-to-md-darwin-x64-4.8.6.zip)
