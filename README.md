...
Issue #470 requests a browser-hosted YARLE experience.
An incremental implementation plan is documented in
[`docs/web-app-roadmap.md`](docs/web-app-roadmap.md).
